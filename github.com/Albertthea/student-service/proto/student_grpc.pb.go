...
type StudentServiceClient interface {
	...
	UpdateStudent(ctx context.Context, in *UpdateStudentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *studentServiceClient) UpdateStudent(ctx context.Context, in *UpdateStudentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type StudentServiceServer interface {
	...
	UpdateStudent(context.Context, *UpdateStudentRequest) (*emptypb.Empty, error)
...
func (UnimplementedStudentServiceServer) UpdateStudent(context.Context, *UpdateStudentRequest) (*emptypb.Empty, error) {
