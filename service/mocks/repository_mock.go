...
// Source: example.com/student-service/service (interfaces: Repository)
...
import (
	...
	domain "example.com/student-service/domain"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 domain.Student) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetByID(arg0 context.Context, arg1 string) (*domain.Student, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(arg0 context.Context) ([]domain.Student, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) ListByGrade(arg0 context.Context, arg1 int32) ([]domain.Student, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByGrade", arg0, arg1)
	ret0, _ := ret[0].([]domain.Student)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepositoryMockRecorder) ListByGrade(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByGrade", reflect.TypeOf((*MockRepository)(nil).ListByGrade), arg0, arg1)
}

// Update mocks base method.
func (m *MockRepository) Update(arg0 context.Context, arg1 domain.Student) error {
	m.ctrl.T.Helper()
